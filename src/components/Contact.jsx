  ...
  return (
    <>
      <style>{`
        ...
        .contact-info-row:hover .contact-info-value {
          color: var(--text);
        }
        ...
        .contact-field.is-focused .contact-field-label {
          color: var(--pu-bright);
        }
        ...
        .contact-field.is-focused .contact-field-bar {
          width: calc(100% - 16px);
        }
      ...
      >
        ...
        <svg className="contact-circuit-svg" viewBox="0 0 1200 700" preserveAspectRatio="xMidYMid slice">
          <path 
            d="M0 150 L180 150 L180 280 L420 280" 
          ...
          <path 
            d="M1200 80 L980 80 L980 200 L750 200" 
          ...
          <path 
            d="M600 700 L600 520 L820 520 L820 420" 
